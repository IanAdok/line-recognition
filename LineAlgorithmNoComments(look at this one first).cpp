...
The task was:
			...
			This had to be done by the given files:  Point.h, Point.c
			...
			the effectiveness of your hash and memory structure and techniques has a big impact if they are used inside.
*/
